...
namespace TypingSystem
{
    ...
    internal class AnswerGenerator
    {
        ...
        /// 正解入力ローマ字候補リスト
        /// </summary>
        internal List<List<string>> AnswerRomajiInputSpellingList { get; private set; }
        /// <summary>
        /// 問題文
        /// </summary>
        internal string QuestionText { get; private set; }
        /// <summary>
        /// 問題文のかな表示
        /// </summary>
        internal string QuestionKanaSpelling { get; private set; }
        /// <summary>
        /// 問題文のかな表記をuni-gram, bi-gramで区切ったもの
        /// </summary>
        internal List<string> CharList { get; private set; }
        /// <summary>
        /// JSONからDictionaryに変換したローマ字かな変換辞書
        /// </summary>
        private Dictionary<string, string[]> RomajiKanaMap { get; set; }
        /// <summary>
        /// 現在選択しているテーブルに登録されている全問題数
        /// </summary>
        private int DataNum { get; set; } = 0;
        /// <summary>
        /// 重複した出題を防ぐための既出問題インデックスリスト
        /// </summary>
        ...
        /// 問題生成用クラス。
        /// </summary>
        /// <param name="jsonFilePath">ローマ字と仮名の入力対応表jsonファイルのパス</param>
        /// <param name="dbPath">問題文字列データベースのパス</param>
        /// <param name="tableName">データベースのテーブル名</param>
        public AnswerGenerator(string jsonFilePath, string dbPath, string tableName)
        {
            ...
            {
                Debug.LogError(QuestionKanaSpelling);
            }
        }
